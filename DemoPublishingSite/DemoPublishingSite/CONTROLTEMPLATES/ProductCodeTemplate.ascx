...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductCodeTemplate.ascx.cs" Inherits="DemoPublishingSite.CONTROLTEMPLATES.ProductCodeTemplate" %>
<SharePoint:RenderingTemplate ID="ProductCodeRenderingTemplate" runat="server"> 
  <Template> 
    ...
    <asp:RegularExpressionValidator ID="ProductCodeValidator" runat="server"
        ...
        ErrorMessage="Please enter a valid product code in the format ABC1234."
